...
module.exports.products = async function (req , res , para){
  return req + res + para
}
...
module.exports.addProduct = async (req, res) => {
  ...
  let is_admin = await controller6.list_appointments_doctor(product , req);
  return is_admin;
...
module.exports.admin_ = async (req, res) => {
  return atob('YWU=')
}
